...
export const DEFAULT_SETTINGS = [
  ...
  },
  {
    ...
    type: 'boolean',
    defaultValue: false,
    label: 'settings.app.watermark.enabled.label',
    description: 'settings.app.watermark.enabled.description',
  },
  {
    namespace: 'app',
    key: 'watermark.logoUrl',
    type: 'string',
    defaultValue: '',
    label: 'settings.app.watermark.logoUrl.label',
    description: 'settings.app.watermark.logoUrl.description',
  },
  {
    namespace: 'app',
    ...
    type: 'number',
    defaultValue: 0.35,
    label: 'settings.app.watermark.opacity.label',
    description: 'settings.app.watermark.opacity.description',
  },
  {
    namespace: 'app',
    key: 'watermark.sizePercent',
    type: 'number',
    defaultValue: 18,
    label: 'settings.app.watermark.sizePercent.label',
    description: 'settings.app.watermark.sizePercent.description',
  },
  {
    namespace: 'app',
    ...
    label: 'settings.app.watermark.position.label',
    description: 'settings.app.watermark.position.description',
  },
  {
    namespace: 'system',
